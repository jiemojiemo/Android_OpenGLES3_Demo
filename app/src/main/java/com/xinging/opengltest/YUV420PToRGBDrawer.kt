...
class YUV420PToRGBDrawer: IDrawer {
    companion object {
        ...
        val fragmentShaderSource =
            ...
            void main()
            {
               ...
               yuv.y = texture(u_texture,v_texcoord).r-0.5;  // u
               yuv.z = texture(v_texture,v_texcoord).r-0.5;  // v
               mat3 m = mat3(
                    1.164, 1.164, 1.164,  
                    0.0, -0.213, 2.112, 
                    1.793, -0.533, 0.0);
    ...
    val texIds = IntBuffer.allocate(3)
    override fun prepare(context: Context) {
        ...
        val width = 700
        val height = 700
        val inputStream = context.resources.openRawResource(R.raw.rainbow_yuv420p)
        ...
        MyGLUtils.checkGlError("configure u texture")
